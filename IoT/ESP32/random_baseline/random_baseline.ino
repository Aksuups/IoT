...
const char* apiKeyIn = "fcqtWd8ty98wj8tLMowXMBLMY8HKIHbV";          /*API key for Sensor1*/
const char* apiKeyInSensor2 = "LYIHKRLvI9wfkabV1t2vjUNEKHaGGYnV";  /*API key for Sensor2*/
