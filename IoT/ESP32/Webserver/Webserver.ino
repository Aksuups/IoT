...
const char *ssid = "ARRIS-B9BA"; // The name of the Wi-Fi network that will be created
const char *password = "D6BE18D1C13CCC4B";   // The password required to connect to it, leave blank for an open network
